...
const player = new Player(client, { searchSongs: ['youtube', 'spotify', 'soundcloud'], debug: true })
...
client.on('interactionCreate', async (interaction) => {
  ...
  if (interaction.commandName === 'playsong') {
    ...
    searchResult.playlist ? queue.tracks.add(searchResult.tracks) : queue.tracks.add(searchResult.tracks[0])
    if (!queue.playing) await queue.player.play(interaction.member.voice.channel, query, interaction.member.name)
